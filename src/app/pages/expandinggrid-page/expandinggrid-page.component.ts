...
@Component({
  selector: 'app-expandinggrid-page',
  standalone: true,
  imports: [ExpandinggridComponent, Highlight, HighlightAuto, HighlightLineNumbers],
  templateUrl: './expandinggrid-page.component.html',
  styleUrl: './expandinggrid-page.component.css'
})
export class ExpandinggridPageComponent {
...
<div id="b2" class="containerTab" style="display:none;background:dodgerblue">
  ...
  codeForHTMLex: string = `<app-expandinggrid></app-expandinggrid>`
