...
codeForHTMLswitchpull= `<app-inputbutton type = 'switch'></app-inputbutton>/>
`
codeForHTMLradiopull= `<app-inputbutton type = 'radio'></app-inputbutton>/>
`
codeforHTMLbuttonts = `import { CommonModule } from '@angular/common';
